...
In February 2022, I quit my job at Splunk to take some time first to relax, then to [focus on finding a fantastic next job](/post/2022/02/06/what-comes-next.html). I managed to do both during my three months of funemployment, landing a job in the [Stripe Atlas](https://stripe.com/atlas) team in May. I was [laid off](https://techcrunch.com/2022/11/03/stripe-cuts-14-of-its-workforce-ceo-says-they-overhired-for-the-world-were-in/) in November 2022, along with most people who were hired during this time.
...
Stripe installed or built an extension to Slack where if a person types `/++ @teammate Something cool` in a public Slack channel, the mentioned teammate and their manager receive a notification of gratitude. This is also stored in a central system, and shows up on the employee's company profile page, and is conceivably available to managers during annual performance reviews. This is a great low-friction way of promoting a positive, grateful culture in the company.
...
So many companies hire solely on technical aptitude, then design the role of the engineer as an implementer of others' ideas. Stripe (and specifically the Atlas team) biases hiring much more strongly on aspirations, track record, taste, and potential. The team is filled with enthusiastic, energetic, fantastic communicators, who are motivated to deliver ideal user experiences. In the right environment, people with these skills will be able to produce a better product and build a better team culture than a dull, code-focused, command-and-control kind of environment.
...
The team culture in Atlas was always light-hearted. Hiring people who know how to communicate challenges in a positive way helps to reinforce this. Keeping team channels public helps to keep everyone on the straight and narrow in avoiding shit-talking other people or teams in the company. Shit talking was culturally unacceptable in the team -- if a private DM conversation started to go in that direction, someone would speak up to take the conversation to a public channel, and things returned to a more constructive tone.
## Friction logs
...
Friction logging is a Stripe-wide practice, so people from our team would regularly friction log offerings or dependencies from other teams, since we are their end-users. This feedback was always welcome and freqently resulted in improvements delivered in short order.


## Shipped emails

A project in the Atlas team was considered done when a Shipped email was sent. This message, sent either to a team-specific group or a companywide group (depending on impact) summarizes the problem and context around the problem, describes the solution approach (usually with screenshots or screen recordings), and quantifies the impact with metrics. It usually ends with a "we haven't won yet..." section where future phases or strategies may be laid out.
